# urlshortener
A simple Django API that listens on /shortener for GET requests with URLs to shorten, and in / for GET requests to return the correponding shortened URL. Made to be hosted free on Pythonanywhere.com.
